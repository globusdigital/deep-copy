...
import (
	github_com_urandom_deep_copy_testdata_import_alias_another_item "github.com/urandom/deep-copy/testdata/import_alias/another/item"
...
func (o Data) DeepCopy() Data {
	...
	if o.AnotherItems != nil {
		cp.AnotherItems = make([]github_com_urandom_deep_copy_testdata_import_alias_another_item.Item, len(o.AnotherItems))
