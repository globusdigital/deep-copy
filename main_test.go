...
func Test_run(t *testing.T) {
	tests := []struct {
		...
		{name: "issue 22, reuse receiver names", types: typesVal{"Foo", "Bar"}, pointer: true, path: "./testdata/issue22", reuseRecvName: true, want: []byte(I22ReuseRecvName)},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			reuseReceiverF = &tt.reuseRecvName
			g := deepcopy.NewGenerator(
				...
				deepcopy.ReuseReceiverNames(tt.reuseRecvName),
			)
...
func (o Foo) DeepCopy() Foo {
	...
	I22ReuseRecvName = `// Code generated by deep-copy; DO NOT EDIT.

package issue22

// DeepCopy generates a deep copy of *Foo
func (xxx *Foo) DeepCopy() *Foo {
	var cp Foo = *xxx
	return &cp
}

// DeepCopy generates a deep copy of *Bar
func (yyy *Bar) DeepCopy() *Bar {
	var cp Bar = *yyy
	return &cp
}`
)
