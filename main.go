...
func main() {
	...
	parts := strings.SplitN(*typeF, ".", 2)
	if len(parts) != 2 {
		log.Fatalln("Error: invalid type selector")
	}
	...
	for _, p := range packages {
		...
		walkType(name, "copy", x, obj, &buf, imports)
	}
